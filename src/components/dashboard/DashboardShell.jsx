        ...
        <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/90 backdrop-blur-xl">
          ...
          {mobileOpen && (
            <div className="border-t border-slate-200 bg-white p-3 lg:hidden">
              {ALL_NAV.map((n) => (
                <Link key={n.to} to={n.to} className={`flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-semibold ${isActive(n.to, n.exact) ? 'bg-primary text-primary-foreground' : 'hover:bg-slate-50'}`}>
